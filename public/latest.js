!function (e) {
    ...
    return function (e, t, n) {
        ...
        1: [function (e, t) {
            function n(e) {
                var t, n, u = this, p = e || {}, l = this.config = {
            ...
            !function () {
                if (function (e, t) {
                        ...
                        n.encodePacket = function (e) {
                            var t = s(o, e.type), n = e.id || "", c = e.endpoint || "", u = e.ack, p = null;
                            switch (e.type) {
                                case"error":
                                    var l = e.reason ? s(i, e.reason) : "", d = e.advice ? s(r, e.advice) : "";
                                    ("" !== l || "" !== d) && (p = l + ("" !== d ? "+" + d : ""));
                                    break;
                                case"message":
                                    "" !== e.data && (p = e.data);
                    ...
                    function n(e) {
                        if (typeof L.addEventListener != x)L.addEventListener("load", e, !1); else if (typeof R.addEventListener != x)R.addEventListener("load", e, !1); else if (typeof L.attachEvent != x)v(L, "onload", e); else if ("function" == typeof L.onload) {
                            var t = L.onload;
                            L.onload = function () {
                                t(), e()
                            }
                    ...
                    function i() {
                        var e = R.getElementsByTagName("body")[0], t = g(j);
                    ...
                    function r() {
                        ...
                        if (e > 0)for (var t = 0; e > t; t++) {
                            var n = B[t].id, o = B[t].callbackFn, i = {success: !1, id: n};
                            if (z.pv[0] > 0) {
                                var r = m(n);
                                if (r)if (!y(B[t].swfVersion) || z.wk && z.wk < 312)if (B[t].expressInstall && s()) {
                                    var p = {};
                    ...
                    function c(e, t, n, o) {
                        ...
                        if (i) {
                            ...
                            var r = z.ie && z.win ? ["Active"].concat("").join("X") : "PlugIn", a = "MMredirectURL=" + L.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + r + "&MMdoctitle=" + R.title;
                    ...
                    var k, C, _, E, T, O, x = "undefined", j = "object", A = "Shockwave Flash", D = "ShockwaveFlash.ShockwaveFlash", I = "application/x-shockwave-flash", M = "SWFObjectExprInst", N = "onreadystatechange", L = window, R = document, P = navigator, F = !1, W = [o], B = [], J = [], V = [], q = !1, U = !1, $ = !0, z = function () {
                        var e = typeof R.getElementById != x && typeof R.getElementsByTagName != x && typeof R.createElement != x, t = P.userAgent.toLowerCase(), n = P.platform.toLowerCase(), o = n ? /win/.test(n) : /win/.test(t), i = n ? /mac/.test(n) : /mac/.test(t), r = /webkit/.test(t) ? parseFloat(t.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, a = !1, s = [0, 0, 0], c = null;
                        if (typeof P.plugins != x && typeof P.plugins[A] == j)c = P.plugins[A].description, !c || typeof P.mimeTypes != x && P.mimeTypes[I] && !P.mimeTypes[I].enabledPlugin || (F = !0, a = !1, c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), s[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), s[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), s[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0); else if (typeof L[["Active"].concat("Object").join("X")] != x)try {
                    ...
                    return function () {
                        ...
                        registerObject: function (e, t, n, o) {
                            ...
                            z.w3 && !(z.wk && z.wk < 312) && e && n && o && i && r ? (w(n, !1), t(function () {
                                o += "", i += "";
                                var t = {};
                                if (d && typeof d === j)for (var m in d)t[m] = d[m];
                                t.data = e, t.width = o, t.height = i;
                                var g = {};
                                if (p && typeof p === j)for (var v in p)g[v] = p[v];
        ...
        }, {"./peer": 11, localmedia: 12, mockconsole: 7, util: 9, webrtcsupport: 5, wildemitter: 3}],
        13: [function (e, t) {
            var n = t.exports = {};
            n.nextTick = function () {
        ...
        }, {filetransfer: 15, rtcpeerconnection: 14, util: 9, webrtcsupport: 5, wildemitter: 3}],
        16: [function (e, t) {
            ...
            t.exports = function (e, t) {
                var o, i = 2 === arguments.length, r = {
                    video: !0,
                    audio: !0
                }, a = "PermissionDeniedError", s = "ConstraintNotSatisfiedError";
        ...
        12: [function (e, t) {
            ...
            var o = e("util"), i = e("hark"), r = e("webrtcsupport"), a = e("getusermedia"), s = e("getscreenmedia"), c = e("wildemitter"), u = e("mediastream-gain"), p = e("mockconsole");
            o.inherits(n, c), n.prototype.start = function (e, t) {
                var n = this, o = e || this.config.media;
                a(o, function (e, i) {
                    return e || (o.audio && n.config.detectSpeakingEvents && n.setupAudioMonitor(i, n.config.harkOptions), n.localStreams.push(i), n.config.autoAdjustMic && (n.gainController = new u(i), n.setMicIfEnabled(.5)), i.onended = function () {
                    }, n.emit("localStream", i)), t ? t(e, i) : void 0
                })
            ...
            !function () {
                function e(e) {
                    ...
                    return function (n, o, i, r) {
                        o = w(o, r, 4);
                        var a = !E(n) && b.keys(n), s = (a || n).length, c = e > 0 ? 0 : s - 1;
                ...
                function o(e) {
                    return function (t, n, o) {
                        n = S(n, o);
                        for (var i = null != t && t.length, r = e > 0 ? 0 : i - 1; r >= 0 && i > r; r += e)if (n(t[r], r, t))return r;
                        return -1
                    }
                }

                function i(e, t) {
                    var n = A.length, o = e.constructor, i = b.isFunction(o) && o.prototype || c, r = "constructor";
                    for (b.has(e, r) && !b.contains(t, r) && t.push(r); n--;)r = A[n], r in e && e[r] !== i[r] && !b.contains(t, r) && t.push(r)
                }

                var r = this, a = r._, s = Array.prototype, c = Object.prototype, u = Function.prototype, p = s.push, l = s.slice, d = c.toString, f = c.hasOwnProperty, h = Array.isArray, m = Object.keys, g = u.bind, v = Object.create, y = function () {
                }, b = function (e) {
                ...
                var k = function (e, t) {
                    return function (n) {
                        ...
                        for (var i = 1; o > i; i++)for (var r = arguments[i], a = e(r), s = a.length, c = 0; s > c; c++) {
                            var u = a[c];
                ...
                }, _ = Math.pow(2, 53) - 1, E = function (e) {
                    var t = e && e.length;
                ...
                b.each = b.forEach = function (e, t, n) {
                    t = w(t, n);
                    var o, i;
                    if (E(e))for (o = 0, i = e.length; i > o; o++)t(e[o], o, e); else {
                        var r = b.keys(e);
                    ...
                    var n = l.call(arguments, 2), o = b.isFunction(t);
                ...
                b.flatten = function (e, t) {
                    ...
                    if ("number" == typeof n)o = 0 > n ? Math.max(0, i + n) : n; else if (n && i)return o = b.sortedIndex(e, t), e[o] === t ? o : -1;
                ...
                var x = function (e, t, n, o, i) {
                    ...
                    var r = C(e.prototype), a = e.apply(r, i);
                ...
                b.bind = function (e, t) {
                    ...
                    var n = l.call(arguments, 2), o = function () {
                ...
                var j = !{toString: null}.propertyIsEnumerable("toString"), A = ["valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString"];
                b.keys = function (e) {
                    if (!b.isObject(e))return [];
                    if (m)return m(e);
                    var t = [];
                    ...
                    t = S(t, n);
                    for (var o, i = b.keys(e), r = 0, a = i.length; a > r; r++)if (o = i[r], t(e[o], o, e))return o
                ...
                var D = function (e, t, n, o) {
                    ...
                    if (n.push(e), o.push(t), r) {
                        ...
                        for (; c--;)if (!D(e[c], t[c], n, o))return !1
                    } else {
                        var u, p = b.keys(e);
                        if (c = p.length, b.keys(t).length !== c)return !1;
                        for (; c--;)if (u = p[c], !b.has(t, u) || !D(e[u], t[u], n, o))return !1
                    }
                ...
                var I = {
                    ...
                    "'": "&#x27;",
                    "`": "&#x60;"
                }, M = b.invert(I), N = function (e) {
                    var t = function (t) {
                        return e[t]
                    }, n = "(?:" + b.keys(e).join("|") + ")", o = RegExp(n), i = RegExp(n, "g");
                    return function (e) {
                ...
                b.template = function (e, t, n) {
                    ...
                    var o = RegExp([(t.escape || R).source, (t.interpolate || R).source, (t.evaluate || R).source].join("|") + "|$", "g"), i = 0, r = "__p+='";
        ...
        14: [function (e, t) {
            ...
            var o = e("underscore"), i = e("util"), r = e("webrtcsupport"), a = e("sdp-jingle-json"), s = e("wildemitter"), c = e("traceablepeerconnection");
            i.inherits(n, s), Object.defineProperty(n.prototype, "signalingState", {
                ...
                if (e.contents || e.jingle && e.jingle.contents) {
                    var i = o.pluck(this.remoteDescription.contents, "name"), s = e.contents || e.jingle.contents;
                    s.forEach(function (e) {
                        var t = e.transport || {}, o = t.candidates || [], s = i.indexOf(e.name), c = e.name;
                    ...
                    n.pc.addIceCandidate(new r.IceCandidate(e.candidate), function () {
                    }, function (e) {
                        n.emit("error", e)
                ...
                var n = this, i = 2 === arguments.length, r = i ? e : {
                    mandatory: {
                        OfferToReceiveAudio: !0,
                        OfferToReceiveVideo: !0
                    }
                };
                return t = i ? t : e, t = t || function () {
                    }, "closed" === this.pc.signalingState ? t("Already closed") : (this.pc.createOffer(function (e) {
                    var i = {type: "offer", sdp: e.sdp};
                ...
                var n = 2 === arguments.length, o = n ? t : e, i = n ? e : {
                    mandatory: {
                        OfferToReceiveAudio: !0,
                        OfferToReceiveVideo: !0
                    }
                ...
                e.jingle && (e.sdp = a.toSessionSDP(e.jingle, {
                    ...
                    n.wtFirefox && window.setTimeout(function () {
                        n.firefoxcandidatebuffer.forEach(function (e) {
                            n.pc.addIceCandidate(new r.IceCandidate(e), function () {
                            }, function (e) {
                                n.emit("error", e)
            ...
            t.exports = function (e, t) {
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    if (window.navigator.userAgent.match("Linux") && (c = 35), u || s >= 26 && c >= s)e = r && e || {
                        ...
                        o[p] = [a, r ? constraint : null], window.postMessage({type: "getScreen", id: p}, "*")
                    }
        ...
        17: [function (e, t) {
            ...
            t.exports = function (e, t) {
                var a = new o;
                if (!i)return a;
                var t = t || {}, s = t.smoothing || .1, c = t.interval || 50, u = t.threshold, p = t.play, l = t.history || 10, d = !0;
                r || (r = new i);
                var f, h, m;
        ...
        22: [function (e, t, n) {
            ...
            n.toSessionSDP = function (e, t) {
                ...
                var o = t.sid || e.sid || Date.now(), i = t.time || Date.now(), r = ["v=0", "o=- " + o + " " + i + " IN IP4 0.0.0.0", "s=-", "t=0 0"], a = e.groups || [];
                ...
                var i = [], r = t.role || "initiator", a = t.direction || "outgoing", s = e.description, c = e.transport, u = s.payloads || [], p = c && c.fingerprints || [], l = [];
        ...
        23: [function (e, t, n) {
            ...
            n._setIdCounter = function (e) {
                ...
                var a = r.creator || "initiator", s = r.role || "initiator", c = r.direction || "outgoing", u = i.lines(e), p = i.lines(t), l = i.mline(u[0]), d = {
                    creator: a,
                    name: l.media,
                    description: {
                        descType: "rtp",
                ...
                "application" == l.media && (d.description = {descType: "datachannel"}, d.transport.sctp = []);
                var f = d.description, h = d.transport, m = i.findLine("a=mid:", u);
                ...
                var _ = i.findLines("a=fingerprint:", u, p), E = i.findLine("a=setup:", u, p);
                _.forEach(function (e) {
                    var t = i.fingerprint(e);
                    E && (t.setup = E.substr(8)), h.fingerprints.push(t)
                });
                var T = i.findLine("a=ice-ufrag:", u, p), O = i.findLine("a=ice-pwd:", u, p);
                if (T && O) {
        ...
        24: [function (e, t) {
            ...
            var r = e("util"), a = e("webrtcsupport"), s = e("wildemitter");
        ...
        }, {util: 9, webrtcsupport: 5, wildemitter: 3}]
    }, {}, [1])(1)
});